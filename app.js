...
const themeOne = document.querySelector(".theme_1");
const themeTwo = document.querySelector(".theme_2");
const themeThree = document.querySelector(".theme_3");
const r = document.documentElement.dataset;
const gridButtons = document.querySelectorAll(".button_grid button");
const deleteButton = document.querySelector("#delete_btn");
const resetButton = document.querySelector("#reset_btn");
const equalToButton = document.querySelector("#equals_btn");
const currentOperand = document.querySelector(".current_operand");
const previousOperand = document.querySelector(".previous_operand");

// TEXT PATTERN IN OPERANDS
